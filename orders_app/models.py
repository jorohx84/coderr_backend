...
from offers_app.models import Offer, OfferDetails, Feature
...
class Order(models.Model):
    ...
    offer_detail = models.ForeignKey(OfferDetails, on_delete=models.PROTECT, related_name='orders')
    title = models.CharField(max_length=255)
    revisions = models.IntegerField()
    delivery_time_in_days = models.IntegerField()
    price = models.DecimalField(max_digits=10, decimal_places=2)
    offer_type = models.CharField(max_length=50, choices=OfferDetails.TYPE_CHOICES)
